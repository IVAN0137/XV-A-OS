...
document.addEventListener("DOMContentLoaded", () => {
  ...
  L.marker([19.4326, -99.1332]).addTo(map).bindPopup("Capilla San Juan Diego").openPopup()
      ...
      setTimeout(() => {
        ...
        if (attendance === "si") {
          message = encodeURIComponent(
            "¡Hola! Confirmo mi asistencia a la celebración de XV años de Ashley Yajaira. ¡Gracias por la invitación!",
          )
        } else {
          message = encodeURIComponent(
            "¡Hola! Lamento no poder asistir a la celebración de XV años de Ashley Yajaira. ¡Que tengan una hermosa fiesta!",
          )
        }
